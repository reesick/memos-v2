                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative space-x-2 flex items-center hover:bg-stone-900 rounded-lg w-fit p-1 px-2 cursor-pointer transition-colors group">
                            <h1 className="text-lg text-stone-200 font-medium">Memos</h1>
                            <span className="text-[10px] bg-sky-500/10 text-sky-500 border border-sky-500/20 px-1.5 rounded uppercase tracking-wider font-bold">LOCAL</span>
                        </div>
